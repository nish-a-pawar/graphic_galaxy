      ...
      <section className="py-24 px-6 bg-[#111827]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-white">Support your promotion with a stronger brand system</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
            <Link to="/brochure-design-sangli" className="rounded-[2rem] border border-white/10 bg-[#0B0F14] p-10 hover:border-amber-400/40 transition-all">
              ...
              <p className="text-white/50">Connect your flyer to detailed marketing collateral for customers who want more information.</p>
            </Link>
            <Link to="/invitation-design-sangli" className="rounded-[2rem] border border-white/10 bg-[#0B0F14] p-10 hover:border-amber-400/40 transition-all">
              <p className="text-sm uppercase tracking-widest text-amber-400 mb-3">Invitation Design</p>
              <h3 className="text-2xl font-black text-white mb-4">Invitation design</h3>
              <p className="text-white/50">Pair event flyers with beautifully designed invites for weddings and launches.</p>
            </Link>
            <Link to="/logo-design-in-sangli" className="rounded-[2rem] border border-white/10 bg-[#0B0F14] p-10 hover:border-amber-400/40 transition-all">
              ...
              <p className="text-white/50">Use a strong brand mark to make every flyer instantly recognizable.</p>
            </Link>
          </div>
        </div>
      </section>
